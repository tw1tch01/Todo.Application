<template>
  <div id="add-todo-item" v-if="item != null">
    <form novalidate class="md-layout" @submit.prevent ref="editForm">
...
export default {
  ...
  created() {
    this.$store.dispatch(`todoItems/${GET_ITEM}`, this.$route.params.itemId);
  }
};
</script>
